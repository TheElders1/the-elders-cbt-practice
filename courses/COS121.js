window.quizData = {
  ...
  "questions": [
    ...
    { "question": "What is abstraction in problem-solving?", "options": ["Breaking a problem into smaller parts", "Focusing on essential details and ignoring irrelevant ones", "Writing code in a specific language", "Testing all possible solutions"], "answer": "Focusing on essential details and ignoring irrelevant ones" },
    { "question": "In the elevator system example, what is an 'essential detail' you care about with abstraction?", "options": ["The brand of the elevator buttons", "The color of the elevator interior", "The floors (states) and requests (inputs)", "The material of the handrails"], "answer": "The floors (states) and requests (inputs)" },
